...
def isTrigOperator(arg):
    trigRatios = ("sin", "cos", "tan", "asin", "acos", "atan")
    if arg in trigRatios:
        return True
    else:
        return False
...
def caseFraction(registerList, arg):
	pass
...
def caseTrigOperator(registerList, arg):
	if arg == "sin":
		xRegister = math.sin(math.radians(float(registerList[0])))
		registerList = replace(registerList, xRegister)
	elif arg == "cos":
		xRegister = math.cos(math.radians(float(registerList[0])))
		registerList = replace(registerList, xRegister)
	elif arg == "tan":
		xRegister = math.tan(math.radians(float(registerList[0])))
		registerList = replace(registerList, xRegister)
	elif arg == "asin":
		xRegister = math.degrees(math.asin(float(registerList[0])))
		registerList = replace(registerList, xRegister)
	elif arg == "acos":
		xRegister = math.degrees(math.acos(float(registerList[0])))
		registerList = replace(registerList, xRegister)
	elif arg == "atan":
		xRegister = math.degrees(math.atan(float(registerList[0])))
		registerList = replace(registerList, xRegister)
	else:
		print("This will never display")
	return registerList
...
def printer(registerList):
	print('\n'*50)
	print("Shrapnitek Business RPN Calculator v4.2", '\n')

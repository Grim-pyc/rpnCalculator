...
def caseMemoryCommand(registerList, arg):
        if arg == "sto":
                userInput = input("What variable would you like to save to? > ")
                D[userInput]
        elif arg == "rcl": 
                userInput = input("What variable would you like to use? > ")
                xRegister = D[userInput]
                shiftUp(registerList, xRegister)
...
def solver(registerList, arg, case):
	...
	elif case == 'memoryCommands':
                registerList = caseMemoryCommand(registerList, arg) 
	else:
		print("error")
	return registerList
